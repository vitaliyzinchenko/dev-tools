...
echo "submit build"
curl -X POST http://localhost:3001/job/oo-all-oss/build --data token=TOKEN --data-urlencode json='{"parameter": [{"name":"REF", "value":"stable"}, {"name":"VERSION", "value":"continuous"}, {"name":"TAG", "value":"false"}, {"name":"PUSH_TAG", "value":""}]}'
